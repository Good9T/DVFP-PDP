...
class PDTSPMatrixEnv:
    ...
    def load_problems(self, batch_size, aug_enable=False, aug_factor=1):
        ...
        self.problems, self.dual_problems, self.node_coords = get_random_problems(
    ...
    def _get_total_cost(self):
        ...
        selected_cost = self.problems[batch_index, node_from, node_to].squeeze(dim=-1)
