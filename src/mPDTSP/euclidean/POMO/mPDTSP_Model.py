...
from mPDTSP_Model_LIB import _get_encoding, reshape_by_heads, multi_head_attention, AddAndInstanceNormalization, FeedForward
...
class PDTSP_Encoder(nn.Module):
    def __init__(self, **model_params):
        ...
        self.emb_depot = nn.Linear(3, self.embedding_dim)
        self.emb_pick = nn.Linear(3, self.embedding_dim)
        self.emb_deli = nn.Linear(3, self.embedding_dim)
        self.encoded_node = None
